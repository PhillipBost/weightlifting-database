    ...
    try {
        ...
        if (error1) {
            ...
            if (error1.message.includes('duplicate key') || error1.message.includes('unique constraint')) {
                ...
                } else if (error1.message.includes('meet_results_meet_id_lifter_id_weight_class_key')) {
                    console.log('   🎯 IDENTIFIED: New constraint "meet_results_meet_id_lifter_id_weight_class_key" is active');
                }
            }
        } else {
        ...
        if (error1 && (error1.message.includes('duplicate key') || error1.message.includes('unique constraint'))) {
            ...
            console.log('✅ NEW CONSTRAINT ACTIVE: meet_results_meet_id_lifter_id_weight_class_key');
