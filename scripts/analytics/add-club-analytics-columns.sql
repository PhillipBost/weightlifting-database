...
ALTER TABLE clubs ADD COLUMN IF NOT EXISTS total_participations INTEGER DEFAULT 0;
...
COMMENT ON COLUMN clubs.total_participations IS 'Total number of athlete-meet combinations for this club during the past 3 years (individual participations, not unique meets)';
