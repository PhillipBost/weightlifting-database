...
// California county lists from wso_information table
const CA_NORTH_CENTRAL_COUNTIES = [
    ...
    'Amador', 'Alpine', 'Nevada', 'Sierra', 'Plumas', 'Butte',
    'Colusa', 'Glenn', 'Tehama', 'Shasta', 'Lassen', 'Modoc',
    'Siskiyou', 'Del Norte', 'Humboldt', 'Trinity', 'Mendocino', 'Lake'
];

const CA_SOUTH_COUNTIES = [
    'Los Angeles', 'Orange', 'Riverside', 'San Bernardino', 'Imperial', 'Ventura',
    'Santa Barbara', 'San Diego', 'Kern', 'Tulare', 'Fresno', 'Kings',
    'Madera', 'Inyo', 'Mono', 'San Luis Obispo'
];
...
function assignCaliforniaWSO(address) {
    ...
    // Simple heuristic: look for major cities/counties
...
async function rebuildAllClubsCorrectWSO() {
    console.log('🔄 Rebuilding all clubs with CORRECT WSO mapping...');
    ...
    try {
        ...
        // Show sample assignments by WSO
        const wsoGroups = {};
