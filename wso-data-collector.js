...
const WSO_DATA = {
    ...
    "California South": {
        ...
        states: ["California"],
        counties: ["Imperial", "Riverside", "San Bernardino", "Orange", "Los Angeles", "Ventura", "Santa Barbara", "Kern", "Tulare", "Fresno", "Kings", "Inyo"], // All counties south of Monterey, Kings, Tulare and Inyo Counties
    ...
    "California North Central": {
        geographic_type: "regional",
        states: ["California"],
        counties: ["Alameda", "Contra Costa", "Marin", "Napa", "San Francisco", "San Mateo", "Santa Clara", "Solano", "Sonoma", "Monterey", "San Benito", "Santa Cruz", "Merced", "Stanislaus", "San Joaquin", "Calaveras", "Tuolumne", "Mariposa"], // All counties north of San Luis Obispo County, Kern County, and San Bernardino County
