...
// Set the mode here - AUTOMATIC for GitHub Actions, INTERACTIVE for manual runs
const CURRENT_MODE = process.env.GITHUB_ACTIONS ? EXECUTION_MODE.AUTOMATIC : EXECUTION_MODE.INTERACTIVE;
